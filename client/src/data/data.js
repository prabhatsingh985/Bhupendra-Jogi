...
export const featureData = [
  ...
  },
  {
    ...
    detail:
      "Find the right service provider to begin working on your issue within minutes.",
  },
  {
    title: "Protected payments, every time",
    detail:
      "You will only receive the payment after the completion of the call, and you'll have full access to the data at that time.",
  },
  {
    title: "24/7 support",
    detail:
